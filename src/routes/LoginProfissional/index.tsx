  ...
  return (
    <div className="flex flex-col gap-6">
      <section className="my-12 mx-4 flex flex-col items-center justify-center gap-4 text-center">
        ...
        <p className="text-lg text-tx-secondary max-w-sm mx-auto">
      ...
      <section className="flex flex-col w-[80%] max-w-100 m-auto border-gray-300 border-2 p-6 gap-6 rounded-xl ">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          <div className="flex flex-col gap-2">
            <label htmlFor="email" className="text-md font-medium text-tx-primary">
            ...
            <div className="relative border-gray-300 border-2 rounded-md p-2 ">
              ...
              <input
                ...
                className="pl-10 text-sm w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:ring-offset-8 disabled:cursor-not-allowed disabled:opacity-50 rounded-xs"
              />
            </div>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="password" className="text-md font-medium text-tx-primary">
              Senha
            </label>
            ...
            <div className="relative border-gray-300 border-2 rounded-md p-2 ">
              ...
              <input
                ...
                className="pl-10 w-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-600 focus-visible:ring-offset-8 disabled:cursor-not-allowed disabled:opacity-50 rounded-xs text-sm"
              />
            </div>
            <p className="text-xs text-tx-secondary">
          ...
          <button
            type="submit"
            className="bg-primary-600 text-white p-2 w-full rounded-lg hover:bg-primary-700"
          >
            Entrar no sistema
          </button>
        </form>
